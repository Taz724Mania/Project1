...
## Details about the API
    ...
    The API pulls information on DnD 5e monsters based on the challenge rating entered.

    https://www.dnd5eapi.co/api/monsters  --this url pulls names of monsters with a challenge rating in a json array
...
## Mockup
    ...
    I want the title to be at the top of the page
    The search section will be directly beneath the title offer a drop-down menu with the available CRs and a search button to the right
    The results should load with the creature name and stats listed on the left and images on the right all in alphabetical order
...
|----|------|-----------------------|
| Sat | Create Readme, Deploy, Get Approval |ReadMe, Deploy, Approval, Built Fetch|
